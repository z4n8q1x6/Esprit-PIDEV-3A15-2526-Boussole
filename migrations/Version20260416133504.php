 ...
 */
final class Version20260416133504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fournisseur CHANGE id id INT NOT NULL, CHANGE franchise_id franchise_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE fournisseur RENAME INDEX fk_fournisseur_franchise TO IDX_369ECA32523CAB89');
        $this->addSql('ALTER TABLE franchises CHANGE email email VARCHAR(100) NOT NULL, CHANGE telephone telephone VARCHAR(20) NOT NULL, CHANGE adresse adresse VARCHAR(200) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE actif actif TINYINT NOT NULL, CHANGE solde_actuel solde_actuel DOUBLE PRECISION NOT NULL');
        ...
        $this->addSql('ALTER TABLE reclamations CHANGE description description LONGTEXT NOT NULL, CHANGE statut statut VARCHAR(50) NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE franchise_id franchise_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE reclamations RENAME INDEX fk_reclamations_franchise TO IDX_1CAD6B76523CAB89');
        $this->addSql('ALTER TABLE transaction CHANGE type type VARCHAR(255) NOT NULL, CHANGE description description VARCHAR(255) NOT NULL, CHANGE franchise_id franchise_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE prenom prenom VARCHAR(50) NOT NULL, CHANGE role role VARCHAR(255) NOT NULL, CHANGE actif actif TINYINT NOT NULL, CHANGE date_creation date_creation DATETIME NOT NULL, CHANGE face_token face_token LONGTEXT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fournisseur CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE franchise_id franchise_id INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE ligne_commande ADD CONSTRAINT `fk_ligne_produit` FOREIGN KEY (produit_id) REFERENCES produit (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        ...
        $this->addSql('ALTER TABLE reclamations CHANGE description description TEXT NOT NULL, CHANGE statut statut VARCHAR(50) DEFAULT \'EN_ATTENTE\', CHANGE date_creation date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE franchise_id franchise_id INT NOT NULL');
        $this->addSql('ALTER TABLE reclamations RENAME INDEX idx_1cad6b76523cab89 TO fk_reclamations_franchise');
        $this->addSql('ALTER TABLE transaction CHANGE type type ENUM(\'RECETTE\', \'DEPENSE\') NOT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE franchise_id franchise_id INT NOT NULL');
        $this->addSql('ALTER TABLE transaction RENAME INDEX idx_723705d1523cab89 TO fk_transaction_franchise');
        $this->addSql('ALTER TABLE utilisateur CHANGE prenom prenom VARCHAR(50) DEFAULT NULL, CHANGE role role ENUM(\'SIEGE\', \'ENTREPRISE\') NOT NULL, CHANGE actif actif TINYINT DEFAULT 1, CHANGE date_creation date_creation DATETIME DEFAULT CURRENT_TIMESTAMP, CHANGE face_token face_token VARCHAR(255) DEFAULT NULL');
