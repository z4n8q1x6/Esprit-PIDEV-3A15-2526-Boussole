 ...
 */
class getBudgetPrevisionnelRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Budget_previsionnelRepository' shared autowired service.
     *
     * @return \App\Repository\Budget_previsionnelRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Budget_previsionnelRepository.php';

        return $container->privates['App\\Repository\\Budget_previsionnelRepository'] = new \App\Repository\Budget_previsionnelRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
