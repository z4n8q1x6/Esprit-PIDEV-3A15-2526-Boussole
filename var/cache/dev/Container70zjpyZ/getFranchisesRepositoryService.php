 ...
 */
class getFranchisesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FranchisesRepository' shared autowired service.
     *
     * @return \App\Repository\FranchisesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FranchisesRepository.php';

        return $container->privates['App\\Repository\\FranchisesRepository'] = new \App\Repository\FranchisesRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
