...
/* back_base.html.twig */
class __TwigTemplate_ec8f3bedc9d817a4784c3337409cd385 extends Template
{
...
\t\t\t\t
                <li class=\"nav-item mt-1\"><a class=\"nav-link text-body py-2 px-4\" href=\"";
        // line 169
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_admin_user");
        yield "\"><i class=\"bi bi-people fa-fw me-3 fs-6\"></i>Utilisateurs</a></li>
        ...
        yield "\"><i class=\"bi bi-building fa-fw me-3 fs-6\"></i>Entreprises</a></li>
...
\t\t\t\t<div class=\"d-flex align-items-center p-3 mb-3 rounded shadow\" style=\"background-color: #2b2b36;\">
                    <div class=\"avatar avatar-sm me-3 d-flex align-items-center justify-content-center fw-bold\" style=\"background-color: #00e5ff; color: #1a1a24; border-radius: 8px;\">
                        ";
        // line 193
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 193, $this->source); })()), "user", [], "any", false, false, false, 193)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 194
            yield "                            ";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::upper($this->env->getCharset(), Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 194, $this->source); })()), "user", [], "any", false, false, false, 194), "prenom", [], "any", false, false, false, 194), 0, 1)), "html", null, true);
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::upper($this->env->getCharset(), Twig\Extension\CoreExtension::slice($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 194, $this->source); })()), "user", [], "any", false, false, false, 194), "nom", [], "any", false, false, false, 194), 0, 1)), "html", null, true);
            yield "
                        ";
        } else {
            // line 196
        ...
        if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 201, $this->source); })()), "user", [], "any", false, false, false, 201)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 201, $this->source); })()), "user", [], "any", false, false, false, 201), "email", [], "any", false, false, false, 201), "html", null, true);
        } else {
            yield "admin@boussole.tn";
        }
        // line 202
        yield "                        </h6>
...
\t\t\t\t</div>
                ...
                <!-- Logout -->
                <a class=\"h6 mb-0 text-danger d-flex align-items-center ms-1 d-inline-block\" href=\"";
        // line 208
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_logout");
        yield "\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"Déconnexion\" style=\"transition: all 0.3s;\">
...
document.addEventListener(\"DOMContentLoaded\", function() {
    ...
    ";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 471, $this->source); })()), "flashes", [], "any", false, false, false, 471));
...
";
    ...
    {
        return array (  723 => 464,  707 => 441,  691 => 127,  652 => 494,  646 => 493,  637 => 490,  629 => 485,  615 => 473,  610 => 472,  606 => 471,  598 => 465,  596 => 464,  591 => 462,  584 => 458,  580 => 457,  574 => 454,  560 => 442,  558 => 441,  538 => 424,  522 => 411,  509 => 401,  454 => 349,  436 => 334,  417 => 318,  399 => 303,  301 => 208,  293 => 202,  287 => 201,  282 => 198,  278 => 196,  271 => 194,  269 => 193,  243 => 170,  239 => 169,  196 => 128,  194 => 127,  153 => 89,  147 => 86,  143 => 85,  139 => 84,  135 => 83,  124 => 75,  48 => 1,);
    }
...
\t\t\t\t
                <li class=\"nav-item mt-1\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('app_admin_user') }}\"><i class=\"bi bi-people fa-fw me-3 fs-6\"></i>Utilisateurs</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('app_admin_entreprise') }}\"><i class=\"bi bi-building fa-fw me-3 fs-6\"></i>Entreprises</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"#\"><i class=\"bi bi-bag fa-fw me-3 fs-6\"></i>Gestion catalogue</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"#\"><i class=\"bi bi-download fa-fw me-3 fs-6\"></i>Commandes reçues</a></li>
...
\t\t\t\t<div class=\"d-flex align-items-center p-3 mb-3 rounded shadow\" style=\"background-color: #2b2b36;\">
                    ...
                    <div>
                        <h6 class=\"mb-0 text-white fw-bold\" style=\"font-size: 0.85rem;\">
                            {% if app.user %}{{ app.user.email }}{% else %}admin@boussole.tn{% endif %}
                        </h6>
                        <small class=\"mb-0\" style=\"color: #00ff88; font-size: 0.75rem;\"><i class=\"bi bi-circle-fill me-1\" style=\"font-size: 0.5rem;\"></i>En ligne</small>
                    </div>
\t\t\t\t</div>
                ...
                <!-- Logout -->
                <a class=\"h6 mb-0 text-danger d-flex align-items-center ms-1 d-inline-block\" href=\"{{ path('app_logout') }}\" data-bs-toggle=\"tooltip\" data-bs-placement=\"top\" title=\"Déconnexion\" style=\"transition: all 0.3s;\">
                    <i class=\"bi bi-power me-2 text-danger\"></i> Déconnexion
                </a>
\t\t\t</div>
\t\t\t<!-- Sidebar footer END -->
