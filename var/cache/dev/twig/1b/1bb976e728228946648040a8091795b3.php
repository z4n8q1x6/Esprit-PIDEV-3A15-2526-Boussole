...
class __TwigTemplate_6c4dee8c384e0e02dd863ee4c9a8f15b extends Template
{
...
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"";
        ...
        yield "\"><i class=\"bi bi-bar-chart fa-fw me-2\"></i>Tableau de bord</a></li>
...
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"";
        // line 141
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("alerte_index");
        yield "\"><i class=\"bi bi-exclamation-triangle fa-fw me-2\"></i>Alertes</a> </li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"";
        // line 142
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reclamation_index");
        yield "\"><i class=\"fas fa-volume-up fa-fw me-2\"></i>Réclamations</a> </li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"";
        ...
        yield "\"><i class=\"bi bi-credit-card fa-fw me-2\"></i>Historique des transactions</a> </li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</li>
...
\t\t\t\t\t<!-- Le Nav item 5 (trois points) a été retiré -->
\t\t\t\t</ul>
\t\t\t\t<!-- Nav Main menu END -->
...
document.addEventListener(\"DOMContentLoaded\", function() {
    ...
    ";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 293, $this->source); })()), "flashes", [], "any", false, false, false, 293));
...
";
    ...
    {
        return array (  530 => 264,  528 => 263,  515 => 262,  438 => 316,  432 => 315,  423 => 312,  415 => 307,  401 => 295,  396 => 294,  392 => 293,  382 => 286,  377 => 284,  373 => 283,  368 => 281,  350 => 265,  348 => 262,  322 => 239,  306 => 226,  295 => 218,  227 => 153,  213 => 142,  209 => 141,  194 => 129,  150 => 88,  144 => 85,  140 => 84,  136 => 83,  125 => 75,  49 => 1,);
    }
...
\t\t\t\t\t\t<a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"demoMenu\" data-bs-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">Principale</a>
\t\t\t\t\t\t<ul class=\"dropdown-menu\" aria-labelledby=\"demoMenu\">
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"{{ path('app_transaction_index') }}\"><i class=\"bi bi-bar-chart fa-fw me-2\"></i>Tableau de bord</a></li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"bi bi-shop fa-fw me-2\"></i>Marketplace</a></li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"bi bi-cart3 fa-fw me-2\"></i>Mon panier</a></li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"bi bi-box-seam fa-fw me-2\"></i>Mes commandes</a></li>
\t\t\t\t\t\t</ul>
...
\t\t\t\t\t\t<ul class=\"dropdown-menu\" aria-labelledby=\"pagesMenu\">
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"fas fa-truck fa-fw me-2\"></i>Fournisseur</a> </li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"{{ path('alerte_index') }}\"><i class=\"bi bi-exclamation-triangle fa-fw me-2\"></i>Alertes</a> </li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"{{ path('reclamation_index') }}\"><i class=\"fas fa-volume-up fa-fw me-2\"></i>Réclamations</a> </li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</li>
...
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"bi bi-calendar3 fa-fw me-2\"></i>Mensualité</a> </li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"#\"><i class=\"fas fa-university fa-fw me-2\"></i>Prêt</a> </li>
\t\t\t\t\t\t\t<li> <a class=\"dropdown-item\" href=\"{{ path('app_transaction_historique') }}\"><i class=\"bi bi-credit-card fa-fw me-2\"></i>Historique des transactions</a> </li>
\t\t\t\t\t\t</ul>
\t\t\t\t\t</li>
