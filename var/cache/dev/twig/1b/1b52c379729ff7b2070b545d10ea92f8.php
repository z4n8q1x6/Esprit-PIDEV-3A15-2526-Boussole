...
/* back_base.html.twig */
class __TwigTemplate_2c84e7c6228b7a99e80a2aaa8e26c140 extends Template
{
...
<a class=\"navbar-brand d-flex align-items-center\" href=\"";
        // line 141
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_siege_dashboard");
        yield "\">
...
\t\t\t\t<li class=\"nav-item mb-1\">
        ...
        // line 164
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_siege_dashboard");
        yield "\" class=\"nav-link active d-flex align-items-center py-2 px-3\" style=\"background-color: rgba(0, 229, 255, 0.08); color: #00e5ff; border-radius: 8px; margin-left: 10px; margin-right: 10px; border-left: 3px solid #00e5ff;\">
...
\t\t\t\t<li class=\"nav-item ms-3 mt-4 mb-2\" style=\"font-size: 0.75rem; letter-spacing: 1px; color: #6c757d; font-weight: bold; text-transform: uppercase;\">Outils</li>
        ...
        yield "\"><i class=\"bi bi-megaphone fa-fw me-3 fs-6\"></i>Réclamations</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"";
        // line 181
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("admin_alerte_index");
        yield "\"><i class=\"bi bi-robot fa-fw me-3 fs-6\"></i>Alertes IA</a></li>
        ...
        yield "\"><i class=\"bi bi-bar-chart-line fa-fw me-3 fs-6\"></i>Bilans</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"";
        // line 184
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_budget_index");
        yield "\"><i class=\"bi bi-piggy-bank fa-fw me-3 fs-6\"></i>Budgets</a></li>
...
";
    ...
    {
        return array (  746 => 462,  724 => 437,  702 => 127,  654 => 492,  648 => 491,  639 => 488,  631 => 483,  617 => 471,  612 => 470,  608 => 469,  600 => 463,  598 => 462,  593 => 460,  586 => 456,  582 => 455,  577 => 453,  571 => 450,  557 => 438,  555 => 437,  535 => 420,  519 => 407,  506 => 397,  451 => 345,  433 => 330,  414 => 314,  396 => 299,  319 => 225,  295 => 204,  272 => 184,  268 => 183,  263 => 181,  259 => 180,  240 => 164,  214 => 141,  199 => 128,  197 => 127,  156 => 89,  150 => 86,  146 => 85,  142 => 84,  138 => 83,  127 => 75,  51 => 1,);
    }
...
\t\t\t\t<li class=\"nav-item ms-3 mt-4 mb-2\" style=\"font-size: 0.75rem; letter-spacing: 1px; color: #6c757d; font-weight: bold; text-transform: uppercase;\">Outils</li>
                ...
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"#\"><i class=\"bi bi-cash fa-fw me-3 fs-6\"></i>Charges</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"#\"><i class=\"bi bi-truck fa-fw me-3 fs-6\"></i>Fournisseurs</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('admin_reclamation_index') }}\"><i class=\"bi bi-megaphone fa-fw me-3 fs-6\"></i>Réclamations</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('admin_alerte_index') }}\"><i class=\"bi bi-robot fa-fw me-3 fs-6\"></i>Alertes IA</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"#\"><i class=\"bi bi-globe fa-fw me-3 fs-6\"></i>Carte franchises</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('app_bilan_index') }}\"><i class=\"bi bi-bar-chart-line fa-fw me-3 fs-6\"></i>Bilans</a></li>
                <li class=\"nav-item\"><a class=\"nav-link text-body py-2 px-4\" href=\"{{ path('app_budget_index') }}\"><i class=\"bi bi-piggy-bank fa-fw me-3 fs-6\"></i>Budgets</a></li>
