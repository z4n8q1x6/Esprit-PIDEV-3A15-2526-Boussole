...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-delete-modern').forEach(function(btn) {
        btn.addEventListener('click', function() {
            ...
            fetch('/afficher_back_charge/delete/' + id, {
                method: 'DELETE',
...
{% endblock %}
", "afficher_back_charge/index.html.twig", "C:\\Users\\Wael\\Esprit-PIDEV-3A15-2526-Boussole\\templates\\afficher_back_charge\\index.html.twig");
    }
}
