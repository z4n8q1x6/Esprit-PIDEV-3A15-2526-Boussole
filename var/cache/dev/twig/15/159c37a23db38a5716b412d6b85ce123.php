...
class __TwigTemplate_89cc0b15acb4a5bc80fc19995a844242 extends Template
{
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 1 & 2. TEXT EDITING AND STATUS TOGGLE (Double Click)
    usersTableBody.addEventListener('dblclick', function(e) {
        const cell = e.target.closest('.editable-cell');
        const statusCell = e.target.closest('.editable-status');

        if (cell) {
            handleTextEdit(cell);
        } else if (statusCell) {
            handleStatusToggle(statusCell);
        }
    });

    async function handleTextEdit(tdElement) {
    ...
    async function handleStatusToggle(tdElement) {
        const contentDiv = tdElement.querySelector('.cell-content');
        const userId = tdElement.closest('tr').getAttribute('data-user-id');
    ...
    // 4. DELETE LOGIC & MODAL (Click Delegation)
    ...
    usersTableBody.addEventListener('click', function(e) {
        ...
        if (deleteBtn) {
            userToDeleteId = deleteBtn.getAttribute('data-id');
...
";
    ...
    {
        return array (  843 => 647,  830 => 646,  728 => 553,  717 => 547,  715 => 546,  705 => 541,  697 => 536,  693 => 535,  688 => 533,  685 => 532,  681 => 530,  677 => 528,  675 => 527,  672 => 526,  670 => 525,  664 => 522,  658 => 519,  652 => 516,  646 => 514,  641 => 513,  604 => 479,  589 => 467,  575 => 456,  547 => 430,  534 => 429,  102 => 6,  89 => 5,  66 => 3,  43 => 1,);
    }
