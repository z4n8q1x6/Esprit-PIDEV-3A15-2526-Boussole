 ...
 */
class getAlerteiasRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AlerteiasRepository' shared autowired service.
     *
     * @return \App\Repository\AlerteiasRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AlerteiasRepository.php';

        return $container->privates['App\\Repository\\AlerteiasRepository'] = new \App\Repository\AlerteiasRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
