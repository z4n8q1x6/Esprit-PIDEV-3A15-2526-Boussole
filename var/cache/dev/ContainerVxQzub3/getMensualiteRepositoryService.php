 ...
 */
class getMensualiteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MensualiteRepository' shared autowired service.
     *
     * @return \App\Repository\MensualiteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MensualiteRepository.php';

        return $container->privates['App\\Repository\\MensualiteRepository'] = new \App\Repository\MensualiteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
