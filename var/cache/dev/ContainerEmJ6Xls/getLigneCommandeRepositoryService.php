...
{
    /**
     * Gets the private 'App\Repository\Ligne_commandeRepository' shared autowired service.
     *
     * @return \App\Repository\Ligne_commandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Ligne_commandeRepository.php';

        return $container->privates['App\\Repository\\Ligne_commandeRepository'] = new \App\Repository\Ligne_commandeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
